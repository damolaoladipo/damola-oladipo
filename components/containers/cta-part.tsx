    ...
    <>
      <div className="w-full overflow-hidden relative m-auto max-w-4xl">
        <HexagonBackground
          ...
          hexagonProps={{
            className: "dark:bg-[#a3f443] bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 dark:from-neutral-90 to-neutral-200 dark:to-neutral-800 inset-x-0",
          }}
        />
      </div>
    </>
