    ...
    <section className="bg-[#F2F0ED] dark:bg-neutral-900 min-h-screen">
      <div className="max-w-6xl mx-auto px-8 md:px-14 lg:px-20 pt-32 md:pt-40 pb-20">
        ...
        <nav className="flex items-center gap-1.5 text-[0.72rem] text-neutral-400 dark:text-neutral-500 mb-12 md:mb-16">
          ...
          <span>/</span>
          <span className="text-neutral-600 dark:text-neutral-400">About</span>
        </nav>
        ...
        <p className="text-xl md:text-2xl lg:text-[1.65rem] font-medium text-neutral-900 dark:text-neutral-100 leading-[1.45] max-w-4xl mb-14 md:mb-20">
          Hello, I am Damola, a product and design engineer based in Nigeria.
          I have a deep passion for all aspects of digital product design and
          engineering. I take pleasure in collaborating with teams and
          like-minded individuals who are driven to tackle challenges through
          the creation of stunning designs and exceptional experiences.
        </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-[1fr_1.2fr] gap-4 flex-1">
              ...
              <div className="flex flex-col justify-center gap-5 py-2">
                <p className="text-[0.85rem] text-neutral-600 dark:text-neutral-400 leading-relaxed">
                  I&apos;m passionate about designing and building memorable
                  digital experiences. My main focus when working on such
                  projects is to translate business ideas and vision into
                  functional, user-friendly, and beautiful digital products
                  that solve real problems.
                </p>
                <p className="text-[0.85rem] text-neutral-600 dark:text-neutral-400 leading-relaxed">
                  With expertise in not only design, but also product
                  engineering and development, I&apos;m able to work on
                  projects from the very first research &amp; design stages
                  all the way to pushing it live.
                </p>
              </div>
            </div>
