...
const Projects = () => {
  ...
  return (
    ...
    <div className="w-full overflow-hidden px-4 py-32">
 ...
 <div className="text-left mb-10">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl">
          I've worked on open-source projects where 
          I've developed applications solving real-world problems. 
          Here are some of the projects I've worked on.
          Here, I want to show my product, design and engineering prowess. Here,
          I want to show my product, design and engineering prowess
        </p>
      </div>
          ...
          >
            <CarouselContent className="flex -ml-4">
              {companies.map((company, index) => (
                <CarouselItem key={index} className="min-w-0 shrink-0 grow-0 flex basis-2/3 pl-4">
                  <div className="glass-3 group text-card-foreground relative flex flex-col overflow-hidden rounded-xl shadow-xl transition-all bg-background/100 grow">
                    <a target="_blank" href={company.url} rel="noopener noreferrer">
                      ...
                      <div className="flex flex-col gap-2 p-6 transition-opacity duration-300 opacity-100">
                        <p className="text-muted-foreground text-sm text-balance">{company.website}</p>
                        <h3 className="text-lg font-semibold tracking-tight text-balance">{company.name}</h3>
                      </div>
                    </a>
                  </div>
                </CarouselItem>
