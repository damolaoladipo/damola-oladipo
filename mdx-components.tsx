...
function Ul({ children, ...props }: React.HTMLAttributes<HTMLUListElement>) {
    return (
        <ul
            {...props}
            className="my-6 pl-5 space-y-2 list-disc marker:text-neutral-400"
        >
            {children}
        </ul>
    );
...
function Ol({ children, ...props }: React.OlHTMLAttributes<HTMLOListElement>) {
    return (
        <ol
            {...props}
            className="my-6 pl-5 space-y-2 list-decimal marker:text-neutral-400"
        >
            {children}
        </ol>
    );
...
function Hr(props: React.HTMLAttributes<HTMLHRElement>) {
    return (
        <hr
            {...props}
            className="my-12 border-0 border-t border-neutral-200 dark:border-neutral-800"
        />
    );
}
