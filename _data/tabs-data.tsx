import { Grab, GrabIcon, Grid, LucideIcon } from "lucide-react"
...
const tabs: Tab[] = [
  {
    id: "sections",
    label: "ML Playground",
    subLabel: "Make designs yours in no time by changing the variables.",
    icon: Grid,
    content: (
      <div className="space-y-6">
        <h3 className="text-3xl font-bold text-foreground mb-4">Choose your sections</h3>
        <p className="text-muted-foreground leading-relaxed text-lg">
          Choose among 100+ components to build a <br/> landing page suited to the needs of your product.
        </p>
